...
function EntranceScreen({ onEnter }: { onEnter: () => void }) {
  return (
    <div style={{
      ...
      {/* Pure CSS animated background orbs — no canvas, always works */}
      <div aria-hidden style={{ position:"absolute", inset:0, pointerEvents:"none" }}>
        <div style={{
          position:"absolute", top:"10%", left:"50%", transform:"translateX(-50%)",
          width:"70vw", height:"40vh", borderRadius:"50%",
          background:"radial-gradient(ellipse, rgba(232,73,15,0.08) 0%, transparent 70%)",
          animation:"breathe 8s ease-in-out infinite",
        }} />
        <div style={{
          position:"absolute", bottom:"15%", left:"20%",
          width:"30vw", height:"30vw", borderRadius:"50%",
          background:"radial-gradient(ellipse, rgba(240,104,48,0.05) 0%, transparent 70%)",
      ...
      <div aria-hidden style={{
        ...
        background:"linear-gradient(90deg, transparent 0%, rgba(232,73,15,0.4) 40%, rgba(240,104,48,0.4) 60%, transparent 100%)",
      }} />

      {/* Content — uses CSS animation classes from globals.css */}
      <div style={{ position:"relative", zIndex:1, textAlign:"center", padding:"0 24px", maxWidth:620 }}>
        ...
        <p className="animate-fade-up delay-100" style={{
          ...
          <span style={{ display:"inline-block", width:24, height:1, background:"rgba(232,73,15,0.4)" }} />
          South Africa
          <span style={{ display:"inline-block", width:24, height:1, background:"rgba(232,73,15,0.4)" }} />
        </p>
        ...
        <p className="animate-fade-up delay-300" style={{
          ...
          color:"rgba(160,154,147,0.65)", lineHeight:1.75,
        ...
        <div className="animate-fade-up delay-700" style={{
          ...
          {[{v:"9+",l:"Cities"},{v:"Live",l:"Always"},{v:"Zero",l:"Identity"}].map(({v,l})=>(
            <div key={l} style={{ textAlign:"center" }}>
              <div style={{ fontSize:14, fontWeight:700, color:"rgba(242,238,233,0.7)", fontFamily:"'Syne',sans-serif", letterSpacing:"-0.02em" }}>{v}</div>
              <div style={{ fontSize:9, color:"rgba(160,154,147,0.3)", fontFamily:"'DM Mono',monospace", textTransform:"uppercase", letterSpacing:"0.14em", marginTop:4 }}>{l}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      <div aria-hidden style={{
        ...
        background:"linear-gradient(90deg, transparent, rgba(232,73,15,0.15), transparent)",
      }} />
...
export default function Page() {
  ...
  return (
    <div className="grain animate-fade-in" style={{
      minHeight:"100vh", backgroundColor:"#060608",
      color:"#F2EEE9", fontFamily:"'DM Sans',sans-serif",
    }}>
      {/* Ambient */}
      <div aria-hidden style={{ position:"fixed", inset:0, pointerEvents:"none", zIndex:0 }}>
        <div style={{ position:"absolute", top:"-20%", left:"50%", transform:"translateX(-50%)", width:"80vw", height:"60vh", background:"radial-gradient(ellipse, rgba(232,73,15,0.04), transparent 70%)" }} />
      </div>
        ...
        <div style={{ maxWidth:1100, margin:"0 auto", padding:"0 24px", height:52, display:"flex", alignItems:"center", justifyContent:"space-between" }}>
          ...
          <Link href="/post">
            <button style={{
              ...
              boxShadow:"0 4px 16px rgba(232,73,15,0.28)", transition:"all 0.2s",
            }}
      ...
      <main style={{ position:"relative", zIndex:1 }}>
        ...
        <section style={{ padding:"80px 24px 64px", textAlign:"center", borderBottom:"1px solid rgba(255,255,255,0.04)" }}>
          <div style={{ maxWidth:640, margin:"0 auto" }}>
            <div className="animate-fade-up delay-100" style={{ opacity:0, display:"inline-flex", alignItems:"center", gap:8, padding:"4px 14px", borderRadius:9999, border:"1px solid rgba(232,73,15,0.2)", background:"rgba(232,73,15,0.06)", marginBottom:28 }}>
            ...
            <h2 className="animate-fade-up delay-200" style={{
              opacity:0,
              fontFamily:"'Syne',sans-serif", fontSize:"clamp(44px,7vw,80px)",
              fontWeight:800, letterSpacing:"-0.04em", lineHeight:0.9, color:"#F2EEE9", marginBottom:20,
            }}>
              For SA<br/>
            ...
            <p className="animate-fade-up delay-300" style={{ opacity:0, fontSize:15, fontWeight:300, color:"rgba(160,154,147,0.65)", lineHeight:1.7, maxWidth:400, margin:"0 auto 36px" }}>
              Anonymous confessions, city rants, reviews, and unfiltered opinions from across South Africa.
            </p>

            <div className="animate-fade-up delay-400" style={{ opacity:0, display:"flex", justifyContent:"center", gap:12, flexWrap:"wrap" }}>
              <Link href="/post" style={{ textDecoration:"none" }}>
                <LiquidButton size="lg" style={{ fontFamily:"'Syne',sans-serif", fontWeight:700, letterSpacing:"0.05em", fontSize:12, textTransform:"uppercase" }}>
                  Post Anonymously
                </LiquidButton>
              </Link>
              <a href="#feed" style={{ display:"inline-flex", alignItems:"center", gap:7, padding:"10px 20px", borderRadius:12, border:"1px solid rgba(255,255,255,0.07)", background:"rgba(255,255,255,0.02)", color:"rgba(160,154,147,0.6)", textDecoration:"none", fontSize:13, transition:"all 0.2s" }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor="rgba(255,255,255,0.13)";e.currentTarget.style.color="#F2EEE9";}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor="rgba(255,255,255,0.07)";e.currentTarget.style.color="rgba(160,154,147,0.6)";}}
              >
        ...
        {/* ── TESTIMONIALS ── */}
        <section className="animate-fade-up delay-300" style={{ opacity:0, padding:"80px 24px", overflow:"hidden", borderBottom:"1px solid rgba(255,255,255,0.04)" }}>
          <div style={{ maxWidth:1100, margin:"0 auto" }}>
            <div style={{ textAlign:"center", marginBottom:56 }}>
              <p style={{ fontSize:10, fontFamily:"'DM Mono',monospace", textTransform:"uppercase", letterSpacing:"0.3em", color:"rgba(160,154,147,0.35)", marginBottom:14 }}>What SA is saying</p>
        ...
        <section style={{ padding:"80px 24px", borderBottom:"1px solid rgba(255,255,255,0.04)" }}>
          <div style={{ maxWidth:900, margin:"0 auto" }}>
            <div style={{ textAlign:"center", marginBottom:48 }}>
              <p style={{ fontSize:10, fontFamily:"'DM Mono',monospace", textTransform:"uppercase", letterSpacing:"0.3em", color:"rgba(160,154,147,0.35)", marginBottom:14 }}>The process</p>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(220px,1fr))", gap:1 }}>
              {[
                ...
                <div key={n} style={{ padding:"32px 28px", border:"1px solid rgba(255,255,255,0.06)", borderRadius: i===0?"12px 0 0 12px":i===2?"0 12px 12px 0":"0", background: i===1?"rgba(232,73,15,0.03)":"transparent", transition:"background 0.25s" }}
                  onMouseEnter={e=>{(e.currentTarget as HTMLElement).style.background="rgba(255,255,255,0.03)";}}
                  onMouseLeave={e=>{(e.currentTarget as HTMLElement).style.background=i===1?"rgba(232,73,15,0.03)":"transparent";}}
                >
                  <div style={{ fontSize:10, fontFamily:"'DM Mono',monospace", color:"rgba(232,73,15,0.5)", letterSpacing:"0.12em", marginBottom:20 }}>{n}</div>
                  ...
                  <p style={{ fontSize:13, color:"rgba(160,154,147,0.55)", lineHeight:1.65, fontWeight:300 }}>{body}</p>
                </div>
              ))}
            </div>
        ...
        <section id="feed" style={{ padding:"80px 24px 120px" }}>
          <div style={{ maxWidth:860, margin:"0 auto" }}>
            ...
            <div style={{ display:"flex", alignItems:"flex-end", justifyContent:"space-between", flexWrap:"wrap", gap:16, marginBottom:36 }}>
              <div>
                <p style={{ fontSize:10, fontFamily:"'DM Mono',monospace", textTransform:"uppercase", letterSpacing:"0.3em", color:"rgba(160,154,147,0.35)", marginBottom:10 }}>Live feed</p>
              ...
              <div style={{ display:"flex", alignItems:"center", gap:7 }}>
                ...
                <span style={{ fontSize:10, fontFamily:"'DM Mono',monospace", color:"rgba(160,154,147,0.3)", textTransform:"uppercase", letterSpacing:"0.12em" }}>live</span>
              </div>
            </div>
            ...
            <div style={{ display:"flex", gap:6, overflowX:"auto", paddingBottom:6, marginBottom:12, scrollbarWidth:"none" }}>
              {AREAS.map(a=>(
                <button key={a} onClick={()=>setArea(a)} style={{
                  ...
                  fontFamily:"'DM Mono',monospace", cursor:"pointer", transition:"all 0.15s", whiteSpace:"nowrap",
                  ...
                  color: area===a?"#E87040":"rgba(160,154,147,0.4)",
                }}>
                  {a}
                </button>
              ))}
            ...
            <div style={{ display:"flex", borderBottom:"1px solid rgba(255,255,255,0.05)", marginBottom:24 }}>
              {[{id:"recent",icon:<Clock size={11}/>,label:"Recent"},{id:"trending",icon:<TrendingUp size={11}/>,label:"Trending"},{id:"top",icon:<Star size={11}/>,label:"Top"}].map(t=>(
                <button key={t.id} onClick={()=>setTab(t.id)} style={{
                  display:"flex", alignItems:"center", gap:6, padding:"9px 16px", fontSize:12,
                  fontFamily:"'DM Sans',sans-serif", fontWeight:500, cursor:"pointer",
                  background:"none", border:"none",
                  color: tab===t.id?"#F2EEE9":"rgba(160,154,147,0.35)",
            ...
            <div style={{ display:"flex", flexDirection:"column" }}>
              {filtered.length===0?(
                <div style={{ textAlign:"center", padding:"80px 0", color:"rgba(160,154,147,0.3)" }}>
                  <p style={{ fontSize:11, fontFamily:"'DM Mono',monospace", textTransform:"uppercase", letterSpacing:"0.14em" }}>No posts in {area} yet</p>
                </div>
              ):filtered.map((post,i)=>{
                ...
                return (
                  <article key={post.id} style={{
                    padding:"22px 0", borderBottom:"1px solid rgba(255,255,255,0.05)",
                    ...
                    <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:11, flexWrap:"wrap", gap:8 }}>
                      <div style={{ display:"flex", alignItems:"center", gap:10 }}>
                        ...
                        <span style={{ display:"flex", alignItems:"center", gap:3, fontSize:10, color:"rgba(160,154,147,0.3)", fontFamily:"'DM Mono',monospace" }}><MapPin size={9}/>{post.area}</span>
                      </div>
                      <span style={{ fontSize:10, color:"rgba(160,154,147,0.2)", fontFamily:"'DM Mono',monospace" }}>{timeAgo(post.createdAt)}</span>
                    </div>
                    <Link href={`/post/${post.id}`} style={{ textDecoration:"none" }}>
                      <p style={{ fontSize:15, lineHeight:1.65, fontWeight:300, color:"rgba(242,238,233,0.75)", marginBottom:14, cursor:"pointer", display:"-webkit-box", WebkitLineClamp:4, WebkitBoxOrient:"vertical", overflow:"hidden", transition:"color 0.15s" }}
                        onMouseEnter={e=>((e.currentTarget as HTMLElement).style.color="#F2EEE9")}
                        onMouseLeave={e=>((e.currentTarget as HTMLElement).style.color="rgba(242,238,233,0.75)")}
                      >{post.content}</p>
                    </Link>
                    <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between" }}>
                      <span style={{ fontSize:10, color:"rgba(160,154,147,0.25)", fontFamily:"'DM Mono',monospace", textTransform:"uppercase", letterSpacing:"0.06em" }}>{label}</span>
                      <div style={{ display:"flex", alignItems:"center", gap:18 }}>
                        <Link href={`/post/${post.id}`} style={{ textDecoration:"none", display:"flex", alignItems:"center", gap:5, fontSize:11, color:"rgba(160,154,147,0.3)", fontFamily:"'DM Mono',monospace", cursor:"pointer" }}>
                        ...
                        <span style={{ display:"flex", alignItems:"center", gap:5, fontSize:11, color:"rgba(160,154,147,0.3)", fontFamily:"'DM Mono',monospace" }}>
            ...
            <div style={{ textAlign:"center", paddingTop:52, borderTop:"1px solid rgba(255,255,255,0.04)", marginTop:8 }}>
              <p style={{ fontSize:10, color:"rgba(160,154,147,0.3)", marginBottom:20, fontFamily:"'DM Mono',monospace", textTransform:"uppercase", letterSpacing:"0.14em" }}>Add your voice</p>
              <Link href="/post" style={{ textDecoration:"none" }}>
        ...
        <footer style={{ borderTop:"1px solid rgba(255,255,255,0.04)", padding:"36px 24px" }}>
          <div style={{ maxWidth:1100, margin:"0 auto", display:"flex", flexDirection:"column", alignItems:"center", gap:14 }}>
            ...
            <p style={{ fontSize:9, color:"rgba(160,154,147,0.2)", fontFamily:"'DM Mono',monospace", letterSpacing:"0.16em", textTransform:"uppercase" }}>Anonymous · Unfiltered · South Africa</p>
            ...
            <p style={{ fontSize:9, color:"rgba(160,154,147,0.12)", fontFamily:"'DM Mono',monospace" }}>© 2026 OnlySA</p>
          </div>
        </footer>
      </main>
    </div>
